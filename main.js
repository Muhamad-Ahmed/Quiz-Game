...
const apiLink = "https://opentdb.com/api.php?amount=5&category=18&type=multiple";
...
async function startQuiz() {
    ...
    for (let i = 0; i < 5; i++) {
        ...
        if (question.user == data[i].correct_answer) {
            ...
            console.log(chalk.bold.italic.yellow(`Correct Answer is ${data[i].correct_answer}`));
        }
    }
